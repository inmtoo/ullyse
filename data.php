<?php
	...
	$data['keywords'] = 'What is yoga, what does yoga work';
	$data['description'] = 'This article answers on a question abot yoga`s work';
	$data['h1'] = 'What does yoga work?';
	$data['title'] = 'What does yoga work?';
	$data['thumbnail'] = '/images/post-23321.jpg?';
	$data['author']['name'] = 'Andrew Solodyk';
	$data['author']['image'] = 'https://soltyk.ru/assets/images/soltykam.jpg';
	$data['author']['url'] = '/authors/solodyk/';
	$data['content'] = '<p>
